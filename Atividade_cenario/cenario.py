...
# Função para desenhar parede de tijolos
...
def draw_brick_corridor(tex_id):
    glBindTexture(GL_TEXTURE_2D, tex_id)

    glPushMatrix()
    glTranslatef(-5, 0, 0)
    glBegin(GL_QUADS)
    glTexCoord2f(0, 0); glVertex3f(0, -2, -10)
    glTexCoord2f(5, 0); glVertex3f(0, -2, 10)
    glTexCoord2f(5, 5); glVertex3f(0, 4, 10)
    glTexCoord2f(0, 5); glVertex3f(0, 4, -10)
    glEnd()
    glPopMatrix()
    ...
    glTranslatef(0, 4, 0)
    glBegin(GL_QUADS)
    glTexCoord2f(0, 0); glVertex3f(-5, 0, -10)
    glTexCoord2f(5, 0); glVertex3f(5, 0, -10)
    glTexCoord2f(5, 5); glVertex3f(5, 0, 10)
    glTexCoord2f(0, 5); glVertex3f(-5, 0, 10)
    glEnd()
    glPopMatrix()

def draw_glass_wall(tex_id):
    glBindTexture(GL_TEXTURE_2D, tex_id)
    ...
    glTexCoord2f(5, 0); glVertex3f(5, -2, 0)
    glTexCoord2f(5, 5); glVertex3f(5, 4, 0)
    glTexCoord2f(0, 5); glVertex3f(-5, 4, 0)
    glEnd()
    glPopMatrix()
...
def main():
    ...
    wood_tex_id = load_texture("madeira.jpg")  
    grass_tex_id = load_texture("grama.jpg")  
    brick_tex_id = load_texture("tijolo.jpg")  
    metal_tex_id = load_texture("metal.jpg")  
    glass_tex_id = load_texture("vidro.jpg") 
    box_tex_id = load_texture("box_hl.jpg") 
    ...
    while running:
        ...
        draw_brick_corridor(brick_tex_id)
        draw_glass_wall(glass_tex_id)
