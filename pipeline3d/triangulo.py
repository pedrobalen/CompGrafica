...
def init():
    glClearColor(255, 255, 255, 1)  # Define a cor de fundo azul (R=0, G=0, B=1, A=1)
...
def draw():
    ...
    glVertex3f(0, 2, 0)    # Vértice superior (Y aumentado)
    glVertex3f(-2, -2, 0)  # Vértice inferior esquerdo (X e Y aumentados)
    glVertex3f(2, -2, 0)   # Vértice inferior direito (X e Y aumentados)
...
def main():
    ...
    global x, y, r, ex, ey, ez, z  # Declara as variáveis globais para uso dentro da função
